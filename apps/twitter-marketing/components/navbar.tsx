    ...
    <Box>
      ...
      >
        ...
        <Flex flex={{base: 2}} justify={{base: 'center', md: 'start'}}>
          <Image
            src="/penguine_twitter_marketing.png"
        ...
        >
          {props.alredeLoggedIn ? (
            <Button
              ...
              href={
                isProduction()
                  ? 'https://id.twi-hika.com/logout' + url
                  : 'http://localhost:4002/logout' + url
              }
              _hover={{
                opacity: 0.8,
              }}
            ...
            <Button
              ...
              href={
                isProduction()
                  ? 'https://id.twi-hika.com/login' + url
                  : 'http://localhost:4002/login' + url
              }
              _hover={{
                opacity: 0.8,
              }}
          ...
          {!props.alredeLoggedIn && (
            <Button
              ...
              href={
                isProduction()
                  ? 'https://id.twi-hika.com/register' + url
                  : 'http://localhost:4002/register' + url
              }
              _hover={{
                opacity: 0.8,
              }}
